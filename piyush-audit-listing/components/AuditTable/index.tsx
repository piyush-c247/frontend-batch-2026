  ...
  return (
    <div className={styles.outerWrapper}>
      ...
      <div className={styles.totalsBlock}>
        <Table className={styles.totalsTable} bordered>
          <ColGroup />
          <tbody>
            <tr>
              <td colSpan={COL_COUNT} className={styles.totalsTitle}>
                Totals
              </td>
            </tr>
            <tr>
              <td colSpan={9} className={styles.totalsEmpty} />
              <td className={styles.totalsCell}>{totalScore}</td>
              <td className={styles.totalsCell}>{totalWeight}</td>
              <td className={styles.totalsCell}>{totalAdjusted}</td>
            </tr>
          </tbody>
        </Table>
      </div>
