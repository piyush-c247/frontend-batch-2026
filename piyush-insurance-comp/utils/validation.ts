...
export const validations = {
  ...
  location_name: {
    ...
    maxLength: { value: 100, message: 'Location name must be less than 100 characters' },
    pattern: {
  ...
  am_best_code: {
    minLength: { value: 5, message: 'AM Best code must be at least 5 characters' },
    maxLength: { value: 10, message: 'AM Best code must be less than 10 characters' },
    pattern: {
  ...
  ibc_code: {
    ...
    maxLength: { value: 15, message: 'IBC code must be less than 15 characters' },
    pattern: {
      value: patterns.alphanumeric,
